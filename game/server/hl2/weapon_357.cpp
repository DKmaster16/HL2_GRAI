...
public:
	...
	{
		static Vector plrCone = vec3_origin;	// Player normal accuracy
		static Vector plrRunCone = VECTOR_CONE_4DEGREES;	// Player sprint accuracy
		static Vector plrJumpCone = VECTOR_CONE_10DEGREES;	// Player jump/midair accuracy
		static Vector npcCone = VECTOR_CONE_3DEGREES;	// Player sprint accuracy
