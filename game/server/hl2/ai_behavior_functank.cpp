...
#define FUNCTANK_FIRE_TIME	15.0f
...
//-----------------------------------------------------------------------------
void CAI_FuncTankBehavior::SetEnemyOccluder(CBaseEntity *pBlocker)
{
...
//-----------------------------------------------------------------------------
CBaseEntity *CAI_FuncTankBehavior::GetEnemyOccluder(void)
{
...
void CAI_FuncTankBehavior::GatherConditions()
{
	...
	{
		if (gpGlobals->curtime - GetOuter()->GetEnemyLastTimeSeen() >= 15.0f)
		{
...
"		TASK_SET_SCHEDULE			SCHEDULE:SCHED_FIRE_FUNCTANK "
"   "
"	Interrupts"
"		COND_NEW_ENEMY"
"		COND_ENEMY_DEAD"
