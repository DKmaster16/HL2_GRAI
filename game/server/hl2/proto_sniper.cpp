...
ConVar bulletSpeed( "bulletspeed", "9000" );	//6000
...
#define SNIPER_DECOY_RADIUS	300
...
void CProtoSniper::LaserOn( const Vector &vecTarget, const Vector &vecDeviance )
{
	...
	// beam movement.	DK: 0.02 is not smooth at 60 fps, should be half 0.0166 for smothness
...
//				Vector vecNoise;
//				pProspect->CollisionProp()->RandomPointInBounds(Vector(0.005, 0.005, 0.005), Vector(0.015, 0.015, 0.015), &vecNoise);
