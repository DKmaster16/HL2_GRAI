...
#define RECENT_DAMAGE_INTERVAL		0.3f	// was 3.0f, now react to being hurt more often
#define RECENT_DAMAGE_THRESHOLD		0.05f	// was 0.2f, now 0.05f = much more sensetive to damage
...
ConVar	sk_metropolice_model_scale_min("sk_metropolice_model_scale_min", "0.95");
ConVar	sk_metropolice_model_scale_max("sk_metropolice_model_scale_max", "1.05");
