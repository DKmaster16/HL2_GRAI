...
typedef enum
{
	...
	ACT_SIGNAL_ADVANCE,		// Flanking
	ACT_SIGNAL_FORWARD,		// Unused 
	ACT_SIGNAL_GROUP,		// First encounter, squad leader signal
	ACT_SIGNAL_HALT,		// Unused 
	ACT_SIGNAL_LEFT,		// Danger from left
	ACT_SIGNAL_RIGHT,		// Danger from right
	ACT_SIGNAL_TAKECOVER,	// Too many enemies
