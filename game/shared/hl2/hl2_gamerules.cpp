...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	bool CHalfLife2::NPC_ShouldDrainPistolAmmo(CBasePlayer *pRecipient)
	{
		...
		{
			if (iCount - m_flAdditionalShots > RandomFloat(sk_ammobal_min_pistol.GetInt(), sk_ammobal_max_pistol.GetInt()))
			return true;
		}
		return false;
	}
	...
	bool CHalfLife2::NPC_ShouldDrainSMGAmmo(CBasePlayer *pRecipient)
	{
		...
		{
			if (iCount - m_flAdditionalShots > RandomFloat(sk_ammobal_min_smg.GetInt(), sk_ammobal_max_smg.GetInt()))
				return true;
		}
		return false;
	}
	...
	bool CHalfLife2::NPC_ShouldDrainAR2Ammo(CBasePlayer *pRecipient)
	{
		...
		{
			if (iCount - m_flAdditionalShots > RandomFloat(sk_ammobal_min_ar2.GetInt(), sk_ammobal_max_ar2.GetInt()))
				return true;
		}
		return false;
	}
	...
	bool CHalfLife2::NPC_ShouldDrainShotgunAmmo(CBasePlayer *pRecipient)
	{
		...
		{
			if (iCount - m_flAdditionalShots > RandomFloat(sk_ammobal_min_shotgun.GetInt(), sk_ammobal_max_shotgun.GetInt()))
				return true;
		}
		return false;
	}
	...
	bool CHalfLife2::NPC_ShouldDrain357Ammo(CBasePlayer *pRecipient)
	{
		...
		{
			if (iCount - m_flAdditionalShots > RandomFloat(sk_ammobal_min_357.GetInt(), sk_ammobal_max_357.GetInt()))
				return true;
		}
		return false;
	}
...
#define BULLET_IMPULSE_EXAGGERATION			1.375
