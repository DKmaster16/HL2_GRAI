...
enum RenderTargetSizeMode_t
{
	...
	RT_SIZE_FULL_FRAME_BUFFER=25,	// (was 4) Same size as frame buffer, or next lower power of 2 if we can't do that.
	RT_SIZE_OFFSCREEN=50,			// Target of specified size, don't mess with dimensions
	RT_SIZE_FULL_FRAME_BUFFER_ROUNDED_UP=26, // Same size as the frame buffer, rounded up if necessary for systems that can't do non-power of two textures.
