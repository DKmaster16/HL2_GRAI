...
extern ConVar sk_357_fire_rate;
...
public:
	...
	float	WeaponAutoAimScale()	{ return 0.75f; }
	...
	virtual float GetFireRate(void) { return sk_357_fire_rate.GetFloat(); }
...
const WeaponProficiencyInfo_t *CWeapon357::GetProficiencyValues()
{
	...
	{
		{ 8.00, 1.00 },	//poor	8/16
		{ 5.00, 0.65 },	//average 5/10
		{ 3.50, 0.60 },	//good 3.5/7
		{ 2.00, 0.50 },	//very good	2/4
