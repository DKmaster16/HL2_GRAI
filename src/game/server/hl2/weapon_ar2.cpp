...
ConVar sk_weapon_ar2_alt_fire_duration( "sk_weapon_ar2_alt_fire_duration", "3" );
ConVar sk_weapon_ar2_alt_fire_mass( "sk_weapon_ar2_alt_fire_mass", "250" );
...
const WeaponProficiencyInfo_t *CWeaponAR2::GetProficiencyValues()
{
	...
	{
		{ 5.00,		0.75	},	//poor 5/10
		{ 4.00,		0.65	},	//average 4/8
		{ 3.00,		0.55	},	//good 3/6
		{ 2.00,		0.45	},	//very good 2/4
