...
public:
	...
	float	WeaponAutoAimScale()	{ return 1.5f; }
...
void CWeaponShotgun::PrimaryAttack( void )
{
	...
	m_flNextPrimaryAttack = gpGlobals->curtime + 99999;
	m_flNextSecondaryAttack = gpGlobals->curtime + SequenceDuration();
...
//		}
	...
	*/
	...
	/*if ( !m_bInReload && ( ( pOwner->m_afButtonReleased & IN_ATTACK ) || ( pOwner->m_afButtonReleased & IN_ATTACK2 ) ) )
	{
		m_flNextSecondaryAttack = m_flSoonestPrimaryAttack;
		m_flNextPrimaryAttack = m_flSoonestPrimaryAttack;
	}*/
}
