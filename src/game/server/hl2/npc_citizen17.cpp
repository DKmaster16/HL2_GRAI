...
ConVar	sk_citizen_heal_toss_player_delay("sk_citizen_heal_toss_player_delay", "15", FCVAR_NONE, "how long between throwing healthkits" );
...
const float HEAL_MOVE_RANGE = 30*12; // 30 feet
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
#define CITIZEN_FOLLOWER_DESERT_FUNCTANK_DIST	60.0f*12.0f
