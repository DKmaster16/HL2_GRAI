...
public:
	...
	virtual const Vector& GetBulletSpread( void )
	{
		...
		static Vector plrAccurateCone = VECTOR_CONE_1DEGREES;	// Zooming or ducking
		static Vector plrCone = VECTOR_CONE_2DEGREES;	// Standing, moving around, the default
		static Vector plrRunCone = VECTOR_CONE_4DEGREES;	// Player sprint accuracy
		static Vector plrJumpCone = VECTOR_CONE_6DEGREES;	// Player jump/midair accuracy
